 ...
 */
        ...
        public enum SynthesizingProcessFlags
        {
        ...
        public enum HandwritingProcessFlags
        {
         ...
         * @param	string usr		- [in] user name.
         * @param	string password		- [in] password.
         * @param	string parameters	- [in] parameters when user login.
         * @see		
         */
        ...
        */
         ...
         * @param	string grammarList		- [in] grammars list, inline grammar support only one.
         * @param	string parameters			- [in] parameters when the session created.
